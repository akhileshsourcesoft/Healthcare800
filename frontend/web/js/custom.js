...
function set_item(item) {
	...
	if(item!=''){
		window.location.href = sitePath+"search/listing?category="+itemKeyArr[0]+"&pname="+itemKeyArr[1]+"&lname="+itemKeyArr[2]+"&s="+itemKeyArr[3]+"&c="+itemKeyArr[4]+'&sp='+itemKeyArr[5]+'&z='+itemKeyArr[6];
	}
}
