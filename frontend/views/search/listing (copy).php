		...
		<?php } ?>
          <ul class="fliterResult">
            ...
            <li>
              ...
              <div class="slidingDiv schedule-calender">
					<div class="prev-day table-responsive">
							<table class="table table-bordered">
								...
								foreach($val['providersDayAvailabilities'] as $providerVal){
									echo $providerVal['slot_date'];
								?>
                                  <tr>
                                    <td><div class="table_date"><span class="today">Today</span><span>Thu</span><span><?php echo $providerVal['slot_date'];?></span></div></td>
                                    <td>
                                    	<ul class="table_inside_datat">
                                        	<li><span>9:15 AM</span></li>
                                        	<li><span>9:15 AM</span></li>
                                        	<li><a href="#">9:15 AM</a></li>
                                        	<li><span>9:15 AM</span></li>
                                        	<li><span>9:15 AM</span></li>
                                        	<li><span>9:15 AM</span></li>
                                        </ul>
                                  ...
                                  <?php } ?>
                                  <tr>
                                    <td><div class="table_date"><span class="today">Today</span><span>Thu</span><span>12 Oct</span></div></td>
                                    <td>Mark</td>
                                    <td>Mark</td>
                                    <td>Mark</td>
                                    <td>Mark</td>
