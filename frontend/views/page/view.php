				  ...
				  <div class="col-md-6 well" style="padding-top:30px; text-align:center;">
					...
					<p>&nbsp;</p>
						...
						<div class="col-md-6 panel panel-default well"  style="text-align:center;">
                            ...
                            ?>
    				<div class="form-group">
						<?= $form->field($contactprovidermodel, 'name')->textInput(['maxlength' => true,'placeholder' => 'Enter Your Name'])->label(false); ?>
					<?= $form->field($contactprovidermodel, 'email')->textInput(['maxlength' => true,'placeholder' => 'Enter Your Email'])->label(false); ?>
					<?= $form->field($contactprovidermodel, 'phone')->textInput(['maxlength' => true,'placeholder' => 'Enter Your Contact Number'])->label(false); ?>
					<?= $form->field($contactprovidermodel, 'provider')->textInput(['maxlength' => true,'placeholder' => 'Enter The Providers Name'])->label(false); ?>
					<?= $form->field($contactprovidermodel, 'subject')->textInput(['maxlength' => true,'placeholder' => 'Enter Your Subject'])->label(false); ?>
                            		<?= $form->field($contactprovidermodel, 'message')->textarea(['rows' => 6,'placeholder' => 'Enter Your Message'])->label(false); ?>
                            <div class="form-group">
                                <?= Html::submitButton($contactprovidermodel->isNewRecord ? 'Submit' : 'Submit', ['class' => $contactmodel->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
