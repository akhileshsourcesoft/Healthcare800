...
$daylistModel = ArrayHelper::map($daylistModel, 'id', 'day_name'); 
	...
	<!------------------------------ Product Content -------------------------------->	   
		...
		<div id="tab2" class="tab-pane fade" style="padding-top:20px; padding-bottom:17px;">   
			<fieldset>
				...
				<div class="timeavailability" id="availability_1" style="clear:both;" >
					<div class="col-md-2 col-sm-2">
						<label class="control-label" for="providerstimeavailability-start_time">Start Time</label>
							<select id="providerstimeavailability-start_time_1" class="form-control daystarttime" name="providerstimeavailability-start_time_1">
								<option value="">Select Start Time</option>
								<?php for($i=1; $i<=12; $i++){
									if($i<=9){ $st = '0'.$i;}else{ $st = $i;}?>
									<option value="<?php echo $st;?>"><?php echo $st;?></option>
								<?php } ?>
							</select>
							<span id="day_starttime_1" class="day_starttime"></span>
						<input type="hidden" name="providersAvailability[]" class="providersAvailabilitylist" id="providersAvailability_1" value="1">
					 </div>
					 <div class="col-md-1 col-sm-1">
						<label class="control-label" for="providerstimeavailability-start_minutes">&nbsp;</label>
						<select id="providerstimeavailability-start_minutes_1" class="form-control daystartminutes" name="providerstimeavailability-start_minutes_1">
					...
					<div class="col-md-1 col-sm-1">
						<label class="control-label" for="providerstimeavailability-time">&nbsp;</label>
						<select id="providerstimeavailability-time_1" class="form-control" name="providerstimeavailability-time_1">
							<option value="AM">AM</option>
							<option value="PM">PM</option>
						</select>
					</div>
					<div class="col-md-2 col-sm-2">
						<label class="control-label" for="providerstimeavailability-end_time">End Time</label>
						<select id="providerstimeavailability-end_time_1" class="form-control dayendtime" name="providerstimeavailability-end_time_1">
							<option value="">Select End Time</option>
							<?php for($j=1; $j<=12; $j++){
									if($j<=9){ $et = '0'.$j;}else{ $et = $j;}?>
									<option value="<?php echo $et;?>"><?php echo $et;?></option>
							<?php } ?>
						</select>
						<span id="day_endtime_1" class="day_endtime"></span>
					 </div>
					 <div class="col-md-1 col-sm-1">
						<label class="control-label" for="providerstimeavailability-end_minutes">&nbsp;</label>
						<select id="providerstimeavailability-end_minutes_1" class="form-control dayendminutes" name="providerstimeavailability-end_minutes_1">
							<option value="00">00</option>
							<option value="15">15</option>
							<option value="30">30</option>
							<option value="45">45</option>
					...
					<div class="col-md-1 col-sm-1">
						<label class="control-label" for="providerstimeavailability-end">&nbsp;</label>
						<select id="providerstimeavailability-end_1" class="form-control" name="providerstimeavailability-end_1">
							<option value="AM">AM</option>
							<option value="PM">PM</option>
						</select>
					</div>
					<div class="col-md-3 col-sm-3">
					<?= $form->field($dayAvailability, 'day_id', ['inputOptions' => [
					'class' => 'form-control dayavailbility','id' => 'providersdayavailability-day_id_1','name' => 'providersdayavailability-day_id_1']])->dropDownList($daylistModel, ['prompt'=>'Select Day'])->label('Day'); ?>
					<span id="dayavail_1" class="dayavail"></span>
					</div>
			
					<div class="col-md-1 col-sm-1 removeBtn" style="display:none;" id="removeBtn_1" onclick="removeRowsButton(this.id);"><img src="<?php echo Yii::$app->request->hostInfo.'/YAB01/backend/web/images/remove.png';?>"></div>
