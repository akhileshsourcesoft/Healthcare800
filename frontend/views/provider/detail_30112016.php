        ...
        <aside class="col-md-3 col-sm-4">
          <div class="detailsRight">
              ...
              <div id="providers_fees">
				...
				<div class="col-md-10 col-sm-10"><?= $form->field($modeltimeslotbooking, 'co_payment')->textInput(['readonly'=>true,'id'=>'copayment_fees'])->label('Insurance Co-payment <span style="color:red">($)</span>');?></div>
              ...
              <div id="paypalpay" style="display:none;">
					<?php $modeltimeslotbooking->deductibles = $providerFees['0']['fees'];?>
...
$("input[name='UserTimeslotBooking[user_type_id]']").click(function(){
	...
	if(patientType==1){
		...
		$("#existing_user").hide();
		$("#new_user").show();
		$("#usertimeslotbooking-paypal_co_payment").val(''); usertimeslotbooking-paypal_co_payment
