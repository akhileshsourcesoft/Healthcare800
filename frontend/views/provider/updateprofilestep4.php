						...
						<div class="col-sm-6">
							...
							<?php 
								if($fileType=='doc' || $fileType=='docx'){ 
									echo '<a href="'.Yii::$app->getUrlManager()->createUrl('provider/filedownloads?cid='.base64_encode($contractModel['id'])).'" target="_blank"><img src="'.Yii::$app->getUrlManager()->createUrl("uploads/contactualimages/doc.png").'" class="contractImages" width="50" height="50" alt="" title=""></a><div id="removeBtn_'.$contractModel['id'].'" onclick="removeImageRowsButton(this.id);"> <img src="'.Yii::$app->getUrlManager()->createUrl("images/remove.png").'"></div>';
								}else if($fileType=='pdf'){
									echo '<a href="'.Yii::$app->getUrlManager()->createUrl('provider/filedownloads?cid='.base64_encode($contractModel['id'])).'" target="_blank"><img src="'.Yii::$app->getUrlManager()->createUrl("uploads/contactualimages/pdf.png").'" class="contractImages" width="50" height="50" alt="" title=""></a><div id="removeBtn_'.$contractModel['id'].'" onclick="removeImageRowsButton(this.id);"> <img src="'.Yii::$app->getUrlManager()->createUrl("images/remove.png").'"></div>';
								}else{
									echo '<img src="'.Yii::$app->getUrlManager()->createUrl("uploads/".$contractModel['images']."").'"
								 class="contractImages" width="50" height="50"><div id="removeBtn_'.$contractModel['id'].'" onclick="removeImageRowsButton(this.id);"> <img src="'.Yii::$app->getUrlManager()->createUrl("images/remove.png").'"></div>';
								}  
							 ?>
...
$(document).ready(function(){
	jQuery(".add_more").on( "click", function(){	
	    ...
	    $("#contactimageslist_"+num).find(".removeBtn").prop('id','removeBtn_'+num);
            $("#contactimageslist_"+num).find(".removeBtn").prop('id','removeBtn_'+num).css('display','block');  
...
function removeImageRowsButton(id){
var rowid = id.split("_");
var contractimg='<?php echo Yii::$app->getUrlManager()->createUrl("provider/deletecontract"); ?>';
var info = 'id=' + rowid[1];
