      ...
      <div class="detailsBox">
        ...
        <aside class="col-md-3 col-sm-4">
          <div class="detailsRight">
              ...
              <div>
				 <?php
				 if(count($providerlist->providerInsuranceCompanies)==0){ 
					 echo $form->field($modeltimeslotbooking, 'booking_pay_type')->hiddenInput(['value'=>'N'])->label(false);
				 }
              ...
              <div>
               ...
               <?php
               //echo count($providerlist->providerContracts);
                if(count($providerlist->providerInsuranceCompanies)>0 && count($providerlist->providerContracts)>0){ ?>
               <div>
              ...
              <div>
				<?php } if(count($providerlist->providerInsuranceCompanies)==0 && count($providerlist->providerContracts)==0){   ?>
				<p class="form-group" style="color:#f04e4e;">Payment is disabled because the doctor either does not cover health insurance or does not upload his contract with healthcare800 or both</p>
				<?php }
				 if(isset(Yii::$app->user->identity->id) && (!empty(Yii::$app->user->identity->id))){ 
					 if(Yii::$app->user->identity->userRole['id'] == USER::URID_USER){ ?>
...
function userBookappointment(){
	...
	var insuranceCompanies = '<?php echo count($providerlist->providerInsuranceCompanies);?>';
