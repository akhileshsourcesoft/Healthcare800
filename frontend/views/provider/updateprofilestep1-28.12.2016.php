...
<div class="container">
	<div class="row" style="padding:15px 0 30px 0">
		<ul class="nav nav-tabs" style="padding-top:30px;">
			<li class="active"><a href="<?php echo Yii::$app->getUrlManager()->createUrl('provider/updateprofilestep1')?>">Step 1</a></li>
		...
		<div class="tab-content" style="padding-top:20px;">
			...
			<div class="col-sm-6">
				<?php if($model->isNewRecord) { ?>
				<?= $form->field($model, 'repeatpassword')->passwordInput(['autocomplete'=>'off'])->label("Repassword"); ?>
				<?php  } else { ?>
				<?= $form->field($model,'repeatpassword')->passwordInput(['maxlength' => 255,'value'=>'password','onfocus'=>"if(this.value=='password') this.value='';",  'onblur'=>"if (this.value == '') {this.value = 'password';}"])->label("Repassword"); ?>
				<?php }  ?>
			</div>		
			<div class="col-sm-6">
