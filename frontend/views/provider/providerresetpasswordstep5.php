...
<div class="container">
	<div class="row" style="padding:15px 0 30px 0">
		<ul class="nav nav-tabs" style="padding-top:30px;">
			...
			<li class="active"><a href="<?php echo Yii::$app->getUrlManager()->createUrl('provider/providerresetpasswordstep5')?>" id="tab5-link">Change Password</a></li>
		</ul>
		<div class="tab-content" style="padding-top:20px;">
			...
			<div id="tab5" class="tab-pane fade in active">
					<div class="row">
					 <div class="col-md-12">
							<?php $form = ActiveForm::begin(['id' => 'providerChangePasswordstep5','options'=>['class'=>'cd-form'],'action' => ['provider/providerresetpasswordstep5']]);
							...
							<div class="clear"></div>
							<div class="col-md-6">
								<button class="btn btn-success" type="button" onclick=providerResetpasswordsstep5('<?php echo Yii::$app->getUrlManager()->createUrl("provider/providerresetpasswordstep4");?>')>Reset Password</button>
