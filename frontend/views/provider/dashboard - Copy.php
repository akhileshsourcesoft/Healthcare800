...
<div class="container">
	<div class="row" style="padding:15px 0 30px 0">
		<div class="contact-providers-form">
		 <p><a href="<?php echo Yii::$app->getUrlManager()->createUrl('provider/updateprofilestep1');?>"><button  name="Edit Profile" class="btn btn-success">Complete Your Profile</button></a></p>
		  <p><a href="<?php echo Yii::$app->getUrlManager()->createUrl('provider/viewappointment');?>"><button  name="View Appointment" class="btn btn-success">View Appointment</button></a></p>
