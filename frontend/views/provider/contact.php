	...
	<!------------------------------ Product Content -------------------------------->	   
		<div id="tab1" class="tab-pane fade in active">
			...
			<?= $form->field($model, 'short_desc')->textarea(['rows' => 5])->label('Description'); ?>
				<span id="user_shortdesc_msg"></span>
...
function validateContactForm(){
	...
	if(user_qualification_id.val()=='Other'){
		if($("#qualification-other_qname").val()==''){
			$("#qual_other_msg").text("Please enter other degree.").css('color','red');
			valid = 0;
		}else{
	...
	var user_shortdesc = jQuery("#user-short_desc");
	if(user_shortdesc.val() == ""){
		$("#user_shortdesc_msg").text("Please enter description.").css('color','red');
		valid = 0;
	}else{
		$("#user_shortdesc_msg").empty();
	}
